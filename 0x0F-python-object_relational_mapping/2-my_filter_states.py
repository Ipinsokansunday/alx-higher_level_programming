#!/usr/bin/python3
"""Lists states from the database hbtn_0e_0_usa based on a provided name pattern."""
...
if __name__ == "__main__":
    if len(sys.argv) != 5:
        print("Usage: python3 my_filter_states.py [DB_USER] [DB_PASSWORD] [DB_NAME] [NAME_PATTERN]")
        sys.exit(1)
